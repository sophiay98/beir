...
from beir.retrieval.search.lexical import ESConfigSearch as ESConfigSearch
...
index_name = "scifact-dfr"  # scifact
api_key="OVFHX2hwVUJyUkJNNnZvQ0xpMWE6MTRlUWN6UXRRNE9Gd21rTkg4TmQxQQ=="
#### Intialize ####
...
number_of_shards = 1
model = ESConfigSearch(
    index_name=index_name,
    index_config=similarity_config,
    api_key=api_key,
    hostname=hostname,
